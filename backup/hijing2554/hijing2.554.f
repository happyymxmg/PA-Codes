...
c  hipyset would be changed accordingly.
c
c  VERSION 2.553    Gabor Papp  01/22/2015
c  PDFSET initialization is taken out from PARTON. This should be done
c  now once in main. pdflib is substituted by LHAPDF. GRV98lo grid is 
c  generated for LHAPDF. hipyset would be changed accordingly.
c
...
c*********************************
	...
	ELSEIF(IHNT2(1) .EQ. 1 .AND. IHNT2(3) .EQ. 1) then
	GOTO 505
	ELSE
